...
[^15]: Discord "servers" have an initial limit of 10000 members, 1000 of which can be online at a time. "Server" owners can request this limit to be increased by filing a support ticket, in which case Discord engineering team looks at the activity of the guild and manually migrates it to a guilds server instance with a larger member limit. Known tiers are: 10k, 100k, 250k(beyond this tier, brand verification and/or partnering required), 500k, 1M.
