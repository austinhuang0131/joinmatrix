...
[^15]: Discord "servers" have an initial limit of 10000 members of which 1000 can be online. "Server" owners can request this limit to be increased by filing a support ticket, in which case Discord engineering team looks at the activity of the guild and manually migrates the it to a guilds server instance with a larger member limit. Known tiers are: 10k, 100k, 250k(beyond this tier, brand verification and/or partnering required), 500k, 1M.
