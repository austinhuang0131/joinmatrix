...
| Size limits of group chats | 10 in group DMs, several tiers in "servers" ranging from 1000 to 1 million, subject to manual transition across those tiers.[^15] | No artificial limits, albeit current implementations do not perform well past a few tens of thousands of members. | 
